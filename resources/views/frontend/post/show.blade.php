<x-main-layout>
    <div class=" flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 mb-2">
        <a href="/" class="md:w-1/3 w-full flex items-center font-semibold hover:underline">
